...
public class DishListChefActivity extends AppCompatActivity {
    List<Dish> dishes;
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dish_list_chef);
        ...
        DishListKmAdapter adapter = new DishListKmAdapter(this,R.layout.list_item_chef,dishes);
